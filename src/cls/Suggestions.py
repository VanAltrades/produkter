...
# base_url = "http://suggestqueries.google.com/complete/search?output=firefox&q="
base_url = "http://suggestqueries.google.com/complete/search?output=firefox&ds=sh&q=" # shopping results
